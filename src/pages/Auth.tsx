      ...
      <div className="w-full max-w-md">
        <div className="bg-card border border-hub-border rounded-2xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 border border-hub-border bg-secondary py-2.5 rounded-lg text-sm font-medium text-foreground hover:bg-accent transition-colors"
          >
